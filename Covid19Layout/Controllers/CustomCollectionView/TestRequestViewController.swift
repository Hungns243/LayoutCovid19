...
class TestRequestViewController: UIViewController {
    ...
    let viewCovid: UIView = {
        let view1 = UIView()
        
        return view1
    }()
    
    let labelCovid: CustomsLabel = {
        let labelcovid = CustomsLabel( " abc ", UIColor.fontLabel(), UIColor.backgroundColor(), .zero)
        
        return labelcovid
    }()
    
    let ovalView: CustomsOval = {
        let oval = CustomsOval(UIColor.backgroundColor(), .zero)
        return oval
    }()
    ...
    func setupLayout() {
        ...
        labelCovid.leadingAnchor.constraint(equalTo: viewCovid.leadingAnchor, constant: 16).isActive = true
        labelCovid.centerYAnchor.constraint(equalTo: viewCovid.centerYAnchor).isActive = true
        labelCovid.widthAnchor.constraint(equalTo: viewCovid.widthAnchor, multiplier: 0.8).isActive = true
        labelCovid.heightAnchor.constraint(equalToConstant: 30).isActive = true
        ...
        collectionView1.backgroundColor = .green
        ...
        buttonCheck.topAnchor.constraint(equalTo: collectionView1.bottomAnchor, constant: 120).isActive = true
